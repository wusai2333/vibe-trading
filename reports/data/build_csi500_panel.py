...
cons = json.load(open("reports/data/csi500_cons.json"))
def suffixed(c):
...
panel["_meta"] = {"universe": "csi500-ashare", "constituent_count": len(fetched),
                  "price_adjustment": "qfq", "survivorship_bias": True,
                  "scrub": _scrub_report, "quality": _quality}

pickle.dump(panel, open("reports/data/csi500_panel.pkl", "wb"))
