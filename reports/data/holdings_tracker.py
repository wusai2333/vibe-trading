...
Scores each holding with the stable-7 rolling-weight blend (same calibration
...
Model upgraded stable-5 -> stable-7 on 2026-08-17 (added limit_dist and
vol_ivol60); percentile trajectories before that date are the stable-5 model.
...
HOLDINGS = {
    # 2026-08-25 用户调仓（原始权重/1.2，约 89% 仓位）：
    # 清仓 中韩半导体ETF/亨通/生益/雅克，新进 兆易/平安/宝丰，中金黄金=000975（现名山金国际）
    "601899.SH": ("紫金矿业", 20.8),
    "603986.SH": ("兆易创新", 20.0),
    "601318.SH": ("中国平安", 12.5),
    "600011.SH": ("华能国际", 11.7),
