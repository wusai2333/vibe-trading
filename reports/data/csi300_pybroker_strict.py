"""Strict bench for pybroker-mined factors (2026-08-21).

Mined from edtechre/pybroker vect.py: pvfit20/pvi20/nvi20/qtrend20/ltrend20.
Same protocol as lit strict: random control (5 seeds) + OOS split 2022-06-30.
"""
...
t0 = time.time()
r = run_bench_strict(zoo="pybroker", universe="csi300-ashare",
                     period="2018-01-01/2026-08-21",
...
json.dump(rows, open(DATA / "csi300_pybroker_strict.json", "w"),
          ensure_ascii=False, indent=1, default=str)
print("SAVED csi300_pybroker_strict.json", file=sys.stderr)
