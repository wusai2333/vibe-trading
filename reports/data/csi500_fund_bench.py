...
Loads the price panel + fund_cache_csi500.pkl (built by build_fund_panel.py),
...
fund = pickle.load(open(DATA / "fund_cache_csi500.pkl", "rb"))
...
t0 = time.time()
r = run_bench_strict(zoo="fundamental", universe="csi500-ashare",
...
json.dump(rows, open(DATA / "csi500_fund_strict.json", "w"),
          ensure_ascii=False, indent=1, default=str)
print(f"SAVED {DATA / 'csi500_fund_strict.json'}", file=sys.stderr)
