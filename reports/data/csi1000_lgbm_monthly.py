...
ds = pickle.load(open(DATA / "zz1000_monthly_features.pkl", "rb"))
...
json.dump(out, open(DATA / "csi1000_lgbm_monthly.json", "w"), ensure_ascii=False, indent=1)
pickle.dump({"pred": pred, "monthly": monthly}, open(DATA / "csi1000_lgbm_monthly.pkl", "wb"))
