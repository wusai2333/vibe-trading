"""Authoritative clean rebuild of csi500_panel.pkl from the pre-scrub backup.
...
Run:  python panel_reconcile.py          (rebuilds + saves csi500_panel.pkl)
"""
import pickle
import sys
...
BACKUP = Path("/tmp/csi500_panel.pkl.bak-20260814")
...
def main() -> None:
    ...
    panel["_meta"] = {"universe": "csi500-ashare",
