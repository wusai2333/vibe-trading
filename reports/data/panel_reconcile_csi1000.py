"""Authoritative clean rebuild of csi1000_panel.pkl from the pre-scrub backup.
...
Run:  python panel_reconcile.py          (rebuilds + saves csi1000_panel.pkl)
"""
import pickle
import sys
...
PANEL = DATA / "csi1000_panel.pkl"
BACKUP = Path("/tmp/csi1000_panel.pkl.bak-20260814")
...
def main() -> None:
    ...
    panel["_meta"] = {"universe": "csi1000-ashare",
